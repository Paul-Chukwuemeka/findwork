-- CreateEnum
CREATE TYPE "Role" AS ENUM ('EMPLOYER', 'DEVELOPER');
...
CREATE TABLE "AlertSub" (
    ...
    CONSTRAINT "AlertSub_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "AlertSub" ADD CONSTRAINT "AlertSub_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
